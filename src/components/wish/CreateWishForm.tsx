  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
      ...
      <div className="border-t pt-6">
        <h3 className="text-lg font-bold text-gray-800 mb-4">参加時確認項目</h3>
        <div>
          <label className="block text-sm font-semibold text-gray-700 mb-2">
            確認タイプ
          </label>
          <select
            ...
            onChange={(e) =>
              setParticipationType(e.target.value as ParticipationSchemaType)
            }
            className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-red-500 focus:border-transparent">
        ...
        {(participationType === "note" || participationType === "mixed") && (
          <div className="mt-4 space-y-3 bg-gray-50 p-4 rounded-lg">
            <div>
              <input
                type="text"
      ...
      <div className="border-t pt-6">
        <h3 className="text-lg font-bold text-gray-800 mb-4">確定後確認項目</h3>
        <div>
          <label className="block text-sm font-semibold text-gray-700 mb-2">
            確認タイプ
          </label>
